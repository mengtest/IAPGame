...
-(void)buyClothes{
    ...
    if(dragonCoinsLeft < 10000){
        ...
        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"提示" message:@"您已成功购得天龙战甲！" delegate:nil cancelButtonTitle:@"高富帅就是爽！" otherButtonTitles:nil, nil];
        [alert show];
        [alert release];
...
-(void)buyFan{
    ...
    if(dragonCoinsLeft < 100000){
        ...
        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"提示" message:@"您已成功购得天龙宝扇！" delegate:nil cancelButtonTitle:@"高富帅就是爽！" otherButtonTitles:nil, nil];
        [alert show];
        [alert release];
...
-(void)buyHat{
    ...
    if(dragonCoinsLeft < 500000){
        ...
        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"提示" message:@"您已成功购得天龙头盔！" delegate:nil cancelButtonTitle:@"高富帅就是爽！" otherButtonTitles:nil, nil];
        [alert show];
        [alert release];
